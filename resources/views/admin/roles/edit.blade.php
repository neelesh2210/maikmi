                    ...
                    {!! Form::model($role, ['method' => 'PATCH', 'route' => ['roles.update', $role->id]]) !!}
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input id="Name" class="form-control" type="text" name="name" required placeholder="Enter Role" value="{{explode("_",$role->name)[0]}}">
                                @error('name')
                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body" style="height: 170px; overflow-x: hidden;">
                                            ...
                                            @foreach ($permission as $value)
                                                <div class="mb-2">
                                                    <input type="checkbox" name="permission[]" id="roles_{{$value->name}}" class="roles_{{$parent->parent_name}} form-check-input" value="{{$value->id}}" @if(in_array($value->id, $rolePermissions)) checked @endif>
