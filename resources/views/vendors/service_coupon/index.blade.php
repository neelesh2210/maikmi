    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{route('vendors.service-coupon.create')}}" class="btn-shadow btn btn-info"><i class="bi bi-plus-lg"></i> New</a>
            </div>
        </div>
    </div>
    <div class="card">
                    ...
                    <tbody>
                        @forelse ($list as $key=> $data)
                            <tr>
                                ...
                                <td>
                                    <x-edit-btn route="{{ route('vendors.service-coupon.edit', $data->id) }}" />
                                    <x-delete-btn route="{{ route('vendors.service-coupon.destroy', $data->id) }}" />
                                </td>
                            </tr>
                        @empty
...
@section('scripts')
    <script>
        $(".status_update").click(function(){
            ...
            $.get("{{ route('vendors.service-coupon.statusUpdate', '') }}/"+id, function(data)
            {
