                    ...
                    <tbody>
                        @forelse ($list as $key=> $data)
                            <tr>
                                ...
                                <td>
                                    {{$data->getServiceCategory($data->service_category_ids)}}
                                </td>
                                ...
                                <td>
                                    <x-edit-btn route="{{ route('vendors.services.edit', $data->id) }}" />
                                    <x-delete-btn route="{{ route('vendors.services.destroy', $data->id) }}" />
                                </td>
                            </tr>
                        @empty
