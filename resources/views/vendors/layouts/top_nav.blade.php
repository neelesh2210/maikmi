...
<div class="app-header header-shadow bg-asteroid header-text-light">
    <div class="app-header__logo">
        <div class="logo-src"><h4 class="text-light">{{config('app.name')}}</h4></div>
                ...
                <div class="widget-content p-0">
                    <div class="widget-content-wrapper">
                            ...
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                    ...
                                    <img width="42" class="rounded-circle"
                                        src="{{imageUrl(auth()->user()->getSalon->image)}}" alt onerror="this.onerror=null; this.src='{{ asset('admin_css/user.png') }}'">
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-info">
                                            <div class="menu-header-image opacity-2"
                                                style="background-image: url('{{asset('vendors_css/assets/images/dropdown-header/city3.jpg')}}');">
                                            </div>
                                            <div class="menu-header-content text-left">
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-left">
                                                            ...
                                                            <div class="widget-subheading opacity-8">{{auth()->user()->getSalon->name}}</div>
                                                        </div>
                                                        <div class="widget-content-right mr-2">
                                                            <a class="btn-pill btn-shadow btn-shine btn btn-danger"
                                                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                            <form id="logout-form" action="{{ route('vendors.logout') }}" method="POST" class="d-none">
                                                                @csrf
                                                            </form>
                                                        </div>
                                                    </div>
                        ...
                        <div class="widget-content-left  ml-3 header-user-info">
                            <div class="widget-heading"> {{auth()->user()->name}} </div>
                            <div class="widget-subheading"> {{auth()->user()->getSalon->name}} </div>
                        </div>
                        {{-- <div class="widget-content-right header-user-info ml-3">
                            <button type="button"
                                class="btn-shadow p-1 btn btn-primary btn-sm show-toastr-example">
                                <i class="bi bi-calendar-check text-white pr-1 pl-1"></i>
                            </button>
                        </div> --}}
                    </div>
                </div>
