    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li>
                    <a href="{{route('vendors.dashboard')}}" class="{{ activeRoute(['vendors.dashboard']) ? 'mm-active' : '' }}">
                        <i class="metismenu-icon bi bi-speedometer"></i>Dashboard
                    </a>
                </li>
                <li class="{{ activeRoute(['vendors.services.index', 'vendors.services.create', 'vendors.services.edit', 'vendors.service-booking.index']) ? 'mm-active' : '' }}">
                    <a href="#">
                        <i class="metismenu-icon bi bi-tags"></i>Service Management
                        <i class="metismenu-state-icon bi bi-chevron-down caret-left"></i>
                    </a>
                    <ul>
                        <li>
                            <a href="{{route('vendors.services.index')}}" class="{{ activeRoute(['vendors.services.index', 'vendors.services.create', 'vendors.services.edit']) ? 'mm-active' : '' }}">
                                <i class="metismenu-icon"></i>Service List
                            </a>
                        </li>
                        <li>
                            <a href="{{route('vendors.service-booking.index')}}" class="{{ activeRoute(['vendors.service-booking.index', 'vendors.service-booking.create', 'vendors.service-booking.edit']) ? 'mm-active' : '' }}">
                                <i class="metismenu-icon"></i>Booking List
                            </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="{{route('vendors.products.index')}}" class="{{ activeRoute(['vendors.products.index', 'vendors.products.create', 'vendors.products.edit']) ? 'mm-active' : '' }}">
                        <i class="metismenu-icon bi bi-clipboard2-data"></i>Product List
                    </a>
                </li>
                <li>
                    <a href="{{route('vendors.availability-hour.index')}}" class="{{ activeRoute(['vendors.availability-hour.index', 'vendors.availability-hour.create', 'vendors.availability-hour.edit']) ? 'mm-active' : '' }}">
                        <i class="metismenu-icon bi bi-clock-history"></i>Availability Hour
                    </a>
                </li>
                <li class="{{ activeRoute(['vendors.service-coupon.index', 'vendors.service-coupon.create', 'vendors.service-coupon.edit', 'vendors.product-coupon.index', 'vendors.product-coupon.create', 'vendors.product-coupon.edit']) ? 'mm-active' : '' }}">
                    <a href="#">
                        <i class="metismenu-icon bi bi-receipt-cutoff"></i>Coupon Management
                        <i class="metismenu-state-icon bi bi-chevron-down caret-left"></i>
                    </a>
                    <ul>
                        <li>
                            <a href="{{route('vendors.service-coupon.index')}}" class="{{ activeRoute(['vendors.service-coupon.index', 'vendors.service-coupon.create', 'vendors.service-coupon.edit']) ? 'mm-active' : '' }}">
                                <i class="metismenu-icon"></i>Service Coupon List
                            </a>
                        </li>
                        <li>
                            <a href="{{route('vendors.product-coupon.index')}}" class="{{ activeRoute(['vendors.product-coupon.index', 'vendors.product-coupon.create', 'vendors.product-coupon.edit']) ? 'mm-active' : '' }}">
                                <i class="metismenu-icon"></i>Product Coupon List
                            </a>
                        </li>
                    </ul>
                </li>
